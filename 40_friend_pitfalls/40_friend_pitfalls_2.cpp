...
class BaseClass {
	...
	public:
		...
		//	where only THIS function is able to access from outside
...
void backdoor(BaseClass &bc) {
	cout << "let's see the private member: " << bc.private_member << endl
		 << "What about the protected member? " << bc.protected_member << endl;
...
void backdoor() {
	...
	cout << "private member: " << bc.private_member << endl
		 << "protected member: " << bc.protected_member << endl;
}
